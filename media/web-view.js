  ...
  const handleAddQuestion = (messageOption) => {
    ...
    answerListElement.innerHTML += `<div class="p-4 self-end mt-2 question-element relative input-background">
                        ...
                        <no-export class="mb-2 flex items-center">
                            <!-- 重新编辑按钮 -->
                            <button title="`+ dictionary["chatgpt.webview.editButtonTitle"] + `" id="edit-button" class="p-1.5 flex items-center rounded-lg absolute right-6 top-6">
                            ...
                            <div class="hidden send-cancel-container flex gap-2">
                                <button title="`+ dictionary["chatgpt.webview.sendButtonTitle"] + `" id="send-button" class="send-button p-1 pr-2 flex items-center rounded-md">
                                <!-- 发送按钮 -->  
                                ...
                                <button title="`+ dictionary["chatgpt.webview.cancelButtonTitle"] + `" id="cancel-button" class="cancel-button p-1 pr-2 flex items-center rounded-md">
                                <!-- 取消按钮 -->   
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3 mr-1">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
                                  </svg>
